...
nv_configs = [
    # block_sizes: [1, 1] - 16 configs (14 with grid folding)
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'last', 'first', 'first'], loop_orders=[[0, 2, 1]], num_sm_multiplier=128, num_stages=6, num_warps=1, pid_type='persistent_blocked', range_flattens=[False, True], range_multi_buffers=[False, None], range_num_stages=[1, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.060736ms
    ...
    # block_sizes: [16, 2] - 3 configs (1 with grid folding)

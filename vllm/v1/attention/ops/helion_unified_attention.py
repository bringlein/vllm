...
nv_config_wofolding = [
    ...
    helion.Config(
        ...
        l2_groupings=[32],
        load_eviction_policies=["last", "first", "last", "first", "last", "first", ""],
        loop_orders=[[0, 2, 1]],
        num_sm_multiplier=128,
        num_stages=6,
        num_warps=1,
    ...
    helion.Config(
        ...
        l2_groupings=[32],
        load_eviction_policies=["last", "", "last", "first", "last", "first", ""],
        loop_orders=[[1, 2, 0]],
        num_sm_multiplier=128,
        num_stages=6,
        num_warps=2,
    ...
    helion.Config(
        ...
        l2_groupings=[32],
        load_eviction_policies=["last", "first", "last", "first", "first", "first", ""],
        loop_orders=[[1, 2, 0]],
        num_sm_multiplier=128,
        num_stages=6,
        num_warps=1,
    ...
    helion.Config(
        ...
        l2_groupings=[1],
        load_eviction_policies=["", "last", "", "last", "last", "last", "last"],
        loop_orders=[[0, 2, 1]],
        maxnreg=64,
        num_sm_multiplier=128,
        num_stages=6,
        ...
        range_num_stages=[4, 3],
        range_unroll_factors=[3, 3],
        range_warp_specializes=[],
    ),  # perf=0.463712ms
    ...
    helion.Config(
        ...
        l2_groupings=[4],
        load_eviction_policies=["first", "first", "first", "first", "", "", "last"],
        loop_orders=[[2, 0, 1]],
        maxnreg=64,
    ...
    helion.Config(
        ...
        l2_groupings=[16],
        load_eviction_policies=["first", "", "first", "", "last", "first", "last"],
        loop_orders=[[1, 2, 0]],
        maxnreg=128,
        num_sm_multiplier=32,
        num_stages=6,
    ...
    helion.Config(
        ...
        l2_groupings=[16],
        load_eviction_policies=["first", "last", "first", "", "first", "first", ""],
        loop_orders=[[2, 0, 1]],
        num_sm_multiplier=1,
        num_stages=1,
        num_warps=4,
    ...
    helion.Config(
        ...
        l2_groupings=[8],
        load_eviction_policies=["last", "last", "", "first", "", "first", "first"],
        loop_orders=[[1, 0, 2]],
        maxnreg=256,
        num_sm_multiplier=4,
        num_stages=3,
...
nv_config_just_folding = [
    ...
    helion.Config(
        ...
        l2_groupings=[2],
        load_eviction_policies=["", "first", "first", "first", "last", "first", "last"],
        loop_orders=[[0, 2, 1]],
        num_stages=8,
        num_warps=1,
        pid_type="flat",
        ...
        range_warp_specializes=[],
    ),  # perf=0.064512ms [FOLDING]
    helion.Config(
        atomic_indexing=[],
        block_sizes=[1, 1],
        grid_foldings=[[4, 0, 32]],
        indexing=[
            "tensor_descriptor",
            "pointer",
            "tensor_descriptor",
...
amd_config_wofolding = [
    ...
    helion.Config(
        ...
        range_flattens=[True, True],
        range_multi_buffers=[True, None],
        range_num_stages=[3, 4],
        range_unroll_factors=[3, 0],
        range_warp_specializes=[],
        waves_per_eu=2,
    ),
    helion.Config(
    ...
    helion.Config(
        ...
        range_flattens=[None, None],
        range_multi_buffers=[False, None],
        range_num_stages=[4, 0],
        range_unroll_factors=[4, 0],
        range_warp_specializes=[],
        waves_per_eu=4,
    ),
    helion.Config(

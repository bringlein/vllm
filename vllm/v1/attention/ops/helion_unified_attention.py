...
nv_config_wofolding = [
    # block_sizes: [1, 1] - 2 configs (0 with grid folding)
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'last', 'first', 'last'], loop_orders=[[0, 2, 1]], num_sm_multiplier=128, num_stages=6, num_warps=1, pid_type='persistent_blocked', range_flattens=[False, True], range_multi_buffers=[False, None], range_num_stages=[1, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.060736ms
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'pointer', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'last', 'first', ''], loop_orders=[[0, 2, 1]], num_sm_multiplier=128, num_stages=6, num_warps=1, pid_type='persistent_blocked', range_flattens=[False, True], range_multi_buffers=[False, None], range_num_stages=[1, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.060768ms

    # block_sizes: [1, 2] - 2 configs (0 with grid folding)
    helion.Config(atomic_indexing=[], block_sizes=[1, 2], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'last', 'first', ''], loop_orders=[[1, 2, 0]], num_sm_multiplier=128, num_stages=6, num_warps=4, pid_type='persistent_blocked', range_flattens=[None, True], range_multi_buffers=[None, True], range_num_stages=[1, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.082144ms
    helion.Config(atomic_indexing=[], block_sizes=[1, 2], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', '', 'last', 'first', 'last', 'first', ''], loop_orders=[[1, 2, 0]], num_sm_multiplier=128, num_stages=6, num_warps=2, pid_type='persistent_blocked', range_flattens=[False, True], range_multi_buffers=[True, True], range_num_stages=[1, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.0832ms

    # block_sizes: [1, 4] - 2 configs (0 with grid folding)
    helion.Config(atomic_indexing=[], block_sizes=[1, 4], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[8], load_eviction_policies=['last', 'first', 'first', 'first', 'last', 'first', 'last'], loop_orders=[[1, 2, 0]], num_sm_multiplier=128, num_stages=4, num_warps=1, pid_type='persistent_interleaved', range_flattens=[True, False], range_multi_buffers=[False, True], range_num_stages=[1, 4], range_unroll_factors=[2, 1], range_warp_specializes=[]),  # perf=0.13424ms
    helion.Config(atomic_indexing=[], block_sizes=[1, 4], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'first', 'first', ''], loop_orders=[[1, 2, 0]], num_sm_multiplier=128, num_stages=6, num_warps=1, pid_type='persistent_interleaved', range_flattens=[False, True], range_multi_buffers=[False, None], range_num_stages=[1, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.20544ms

    # block_sizes: [1, 8] - 2 configs (0 with grid folding)
    helion.Config(atomic_indexing=[], block_sizes=[1, 8], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor'], l2_groupings=[64], load_eviction_policies=['', '', 'last', 'first', '', 'first', ''], loop_orders=[[0, 1, 2]], maxnreg=32, num_sm_multiplier=1, num_stages=2, num_warps=16, pid_type='persistent_interleaved', range_flattens=[True, False], range_multi_buffers=[False, None], range_num_stages=[1, 2], range_unroll_factors=[2, 0], range_warp_specializes=[]),  # perf=0.410512ms
    helion.Config(atomic_indexing=[], block_sizes=[1, 8], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'pointer', 'tensor_descriptor'], l2_groupings=[1], load_eviction_policies=['', 'last', '', 'last', 'last', 'last', 'last'], loop_orders=[[0, 2, 1]], maxnreg=64, num_sm_multiplier=128, num_stages=6, num_warps=4, pid_type='persistent_blocked', range_flattens=[None, None], range_multi_buffers=[True, None], range_num_stages=[4, 3], range_unroll_factors=[3, 3], range_warp_specializes=[]),  # perf=0.463712ms

    # block_sizes: [1, 32] - 1 config (0 with grid folding)
    helion.Config(atomic_indexing=[], block_sizes=[1, 32], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[4], load_eviction_policies=['first', 'first', 'first', 'first', '', '', 'last'], loop_orders=[[2, 0, 1]], maxnreg=64, num_sm_multiplier=32, num_stages=1, num_warps=32, pid_type='persistent_interleaved', range_flattens=[True, True], range_multi_buffers=[None, True], range_num_stages=[2, 1], range_unroll_factors=[2, 1], range_warp_specializes=[]),  # perf=2.674208ms

    # block_sizes: [2, 1] - 1 config (0 with grid folding)
    helion.Config(block_sizes=[2, 1], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[8], load_eviction_policies=['first', 'first', 'first', 'last', '', 'first', 'first'], loop_orders=[[2, 1, 0]], num_sm_multiplier=4, num_stages=1, num_warps=8, pid_type='persistent_interleaved', range_flattens=[True, False], range_multi_buffers=[None, None], range_num_stages=[2, 3], range_unroll_factors=[1, 1], range_warp_specializes=[]),  # perf=0.083808ms

    # block_sizes: [2, 2] - 1 config (0 with grid folding)
    helion.Config(block_sizes=[2, 2], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'pointer', 'pointer', 'pointer', 'pointer', 'pointer', 'pointer'], l2_groupings=[2], load_eviction_policies=['last', 'last', 'first', 'last', 'first', 'first', 'last'], loop_orders=[[1, 0, 2]], num_sm_multiplier=1, num_stages=4, num_warps=32, pid_type='persistent_interleaved', range_flattens=[False, True], range_multi_buffers=[None, None], range_num_stages=[3, 1], range_unroll_factors=[1, 4], range_warp_specializes=[]),  # perf=0.410816ms

    # block_sizes: [4, 1] - 1 config (0 with grid folding)
    helion.Config(block_sizes=[4, 1], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[4], load_eviction_policies=['first', 'first', 'first', 'last', 'first', 'first', 'first'], loop_orders=[[1, 2, 0]], num_sm_multiplier=4, num_stages=1, num_warps=4, pid_type='persistent_interleaved', range_flattens=[True, False], range_multi_buffers=[None, None], range_num_stages=[2, 3], range_unroll_factors=[1, 1], range_warp_specializes=[]),  # perf=0.08712ms

    # block_sizes: [8, 2] - 1 config (0 with grid folding)
    helion.Config(block_sizes=[8, 2], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'pointer', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[16], load_eviction_policies=['last', '', 'first', '', 'last', 'first', ''], loop_orders=[[1, 2, 0]], maxnreg=128, num_sm_multiplier=8, num_stages=6, num_warps=4, pid_type='persistent_interleaved', range_flattens=[None, None], range_multi_buffers=[True, False], range_num_stages=[2, 4], range_unroll_factors=[0, 1], range_warp_specializes=[]),  # perf=0.076992ms

    # block_sizes: [8, 4] - 1 config (0 with grid folding)
    helion.Config(block_sizes=[8, 4], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[32], load_eviction_policies=['first', 'first', 'first', 'last', 'first', 'last', 'first'], loop_orders=[[0, 1, 2]], num_sm_multiplier=4, num_stages=1, num_warps=8, pid_type='persistent_interleaved', range_flattens=[None, False], range_multi_buffers=[True, None], range_num_stages=[2, 1], range_unroll_factors=[1, 1], range_warp_specializes=[]),  # perf=0.142128ms

    # block_sizes: [8, 8] - 1 config (0 with grid folding)
    ...
    # block_sizes: [16, 2] - 2 configs (0 with grid folding)
    helion.Config(block_sizes=[16, 2], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'tensor_descriptor', 'pointer', 'pointer', 'pointer', 'tensor_descriptor', 'pointer', 'pointer'], l2_groupings=[16], load_eviction_policies=['first', '', 'first', '', 'last', 'first', 'last'], loop_orders=[[1, 2, 0]], maxnreg=128, num_sm_multiplier=32, num_stages=6, num_warps=4, pid_type='persistent_interleaved', range_flattens=[None, None], range_multi_buffers=[True, False], range_num_stages=[2, 4], range_unroll_factors=[2, 1], range_warp_specializes=[]),  # perf=0.07664ms
    helion.Config(block_sizes=[16, 2], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'pointer', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', 'last', '', 'last', '', 'last', 'last'], loop_orders=[[1, 2, 0]], num_sm_multiplier=16, num_stages=6, num_warps=4, pid_type='persistent_blocked', range_flattens=[False, False], range_multi_buffers=[False, True], range_num_stages=[1, 1], range_unroll_factors=[1, 2], range_warp_specializes=[]),  # perf=0.08192ms

    # block_sizes: [16, 4] - 2 configs (0 with grid folding)
    helion.Config(block_sizes=[16, 4], grid_foldings=[[0, 0, 0]], indexing=['pointer', 'pointer', 'pointer', 'pointer', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[1], load_eviction_policies=['', 'last', '', 'last', '', 'last', 'last'], loop_orders=[[2, 0, 1]], num_sm_multiplier=16, num_stages=6, num_warps=4, pid_type='persistent_blocked', range_flattens=[False, False], range_multi_buffers=[False, True], range_num_stages=[0, 1], range_unroll_factors=[1, 1], range_warp_specializes=[]),  # perf=0.129248ms
    helion.Config(block_sizes=[16, 4], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'pointer', 'tensor_descriptor'], l2_groupings=[16], load_eviction_policies=['first', 'last', 'first', '', 'first', 'first', ''], loop_orders=[[2, 0, 1]], num_sm_multiplier=1, num_stages=1, num_warps=4, pid_type='persistent_interleaved', range_flattens=[False, False], range_multi_buffers=[None, True], range_num_stages=[0, 2], range_unroll_factors=[1, 0], range_warp_specializes=[]),  # perf=0.258848ms

    # block_sizes: [32, 1] - 1 config (0 with grid folding)
    helion.Config(block_sizes=[32, 1], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[64], load_eviction_policies=['first', 'first', 'first', 'last', 'first', '', 'first'], loop_orders=[[0, 2, 1]], num_sm_multiplier=4, num_stages=1, num_warps=4, pid_type='persistent_interleaved', range_flattens=[True, False], range_multi_buffers=[None, None], range_num_stages=[2, 2], range_unroll_factors=[1, 1], range_warp_specializes=[]),  # perf=0.092288ms

    # block_sizes: [32, 4] - 2 configs (0 with grid folding)
    helion.Config(block_sizes=[32, 4], grid_foldings=[[0, 0, 0]], indexing=['tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[8], load_eviction_policies=['last', 'last', '', 'first', '', 'first', 'first'], loop_orders=[[1, 0, 2]], maxnreg=256, num_sm_multiplier=4, num_stages=3, num_warps=8, pid_type='persistent_interleaved', range_flattens=[False, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[2, 1], range_warp_specializes=[]),  # perf=0.202848ms
...
nv_config_just_folding = [
    # block_sizes: [1, 1] - 14 configs (14 with grid folding)
    helion.Config(block_sizes=[1, 1], grid_foldings=[[2, 0, 4]], indexing=['pointer', 'tensor_descriptor', 'pointer', 'pointer', 'pointer', 'tensor_descriptor', 'pointer', 'tensor_descriptor'], l2_groupings=[2], load_eviction_policies=['', 'first', 'first', 'first', 'last', 'first', 'last'], loop_orders=[[0, 2, 1]], num_stages=8, num_warps=1, pid_type='flat', range_flattens=[None, False], range_multi_buffers=[None, True], range_num_stages=[0, 3], range_unroll_factors=[0, 0], range_warp_specializes=[]),  # perf=0.064512ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[4, 0, 32]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'last', 'first', 'last'], loop_orders=[[1, 2, 0]], num_stages=6, num_warps=1, pid_type='flat', range_flattens=[None, True], range_multi_buffers=[None, True], range_num_stages=[0, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.06544ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[4, 0, 32]], indexing=['tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[32], load_eviction_policies=['last', 'first', 'last', 'first', 'last', 'first', ''], loop_orders=[[1, 2, 0]], num_stages=6, num_warps=2, pid_type='flat', range_flattens=[None, True], range_multi_buffers=[None, True], range_num_stages=[0, 2], range_unroll_factors=[0, 3], range_warp_specializes=[]),  # perf=0.071616ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['last', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.07456ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, True], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.07488ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.07536ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 0, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.075872ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, False], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.076192ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 0, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[2], load_eviction_policies=['last', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.076928ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'last', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=2, pid_type='flat', range_flattens=[None, False], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.077184ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor'], l2_groupings=[2], load_eviction_policies=['last', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=1, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.077504ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'last', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=2, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.077696ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['first', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=2, pid_type='flat', range_flattens=[None, None], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.077696ms [FOLDING]
    helion.Config(atomic_indexing=[], block_sizes=[1, 1], grid_foldings=[[8, 2, 0]], indexing=['tensor_descriptor', 'tensor_descriptor', 'pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer'], l2_groupings=[2], load_eviction_policies=['', '', 'first', '', '', '', 'last'], loop_orders=[[0, 1, 2]], num_stages=7, num_warps=2, pid_type='flat', range_flattens=[None, False], range_multi_buffers=[None, False], range_num_stages=[0, 4], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.077888ms [FOLDING]

    # block_sizes: [16, 2] - 1 config (1 with grid folding)
    helion.Config(block_sizes=[16, 2], grid_foldings=[[0, 0, 2]], indexing=['pointer', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'tensor_descriptor', 'pointer', 'pointer', 'tensor_descriptor'], l2_groupings=[2], load_eviction_policies=['first', 'last', 'first', 'first', 'last', 'last', 'last'], loop_orders=[[2, 1, 0]], num_stages=3, num_warps=4, pid_type='flat', range_flattens=[None, True], range_multi_buffers=[None, True], range_num_stages=[0, 2], range_unroll_factors=[0, 2], range_warp_specializes=[]),  # perf=0.070144ms [FOLDING]
]

# Determine which configs to use based on environment variable
if os.getenv('HELION_CONFIG_MODE', 'all').lower() == 'wofolding':
    nv_configs = nv_config_wofolding
elif os.getenv('HELION_CONFIG_MODE', 'all').lower() == 'just_folding':
    nv_configs = nv_config_just_folding
else:
    nv_configs = nv_config_wofolding + nv_config_just_folding


amd_config_wofolding = [
    # block_sizes: [1, 16] - 1 config (0 with grid folding)
    ...
    # block_sizes: [1, 1] - 1 config (0 with grid folding)
    ...
    # block_sizes: [1, 4] - 1 config (0 with grid folding)
    ...
    # block_sizes: [16, 1] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [16, 4] - 1 config (0 with grid folding)
    ...
    # block_sizes: [16, 8] - 1 config (0 with grid folding)
    ...
    # block_sizes: [2, 1] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [2, 4] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [32, 1] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [32, 2] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [4, 2] - 1 config (0 with grid folding)
    ...
    # block_sizes: [4, 4] - 1 config (0 with grid folding)
    ...
    # block_sizes: [4, 8] - 1 config (0 with grid folding)
    ...
    # block_sizes: [64, 1] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [64, 2] - 2 configs (0 with grid folding)
    ...
    # block_sizes: [64, 4] - 1 config (0 with grid folding)
    ...
    # block_sizes: [8, 1] - 1 config (0 with grid folding)
    ...
    # block_sizes: [8, 4] - 2 configs (0 with grid folding)
...
amd_config_just_folding = [
    # block_sizes: [1, 1] - 12 configs (12 with grid folding)
    ...
    # block_sizes: [1, 2] - 1 config (1 with grid folding)
    ...
    # block_sizes: [1, 4] - 3 configs (3 with grid folding)
    ...
    # block_sizes: [1, 8] - 1 config (1 with grid folding)
    ...
    # block_sizes: [32, 1] - 1 config (1 with grid folding)
    ...
    # block_sizes: [4, 2] - 1 config (1 with grid folding)
    ...
    # block_sizes: [8, 1] - 1 config (1 with grid folding)
...
# Determine which configs to use based on environment variable
if os.getenv('HELION_CONFIG_MODE', 'all').lower() == 'wofolding':
    amd_configs = amd_config_wofolding
elif os.getenv('HELION_CONFIG_MODE', 'all').lower() == 'just_folding':
    amd_configs = amd_config_just_folding
else:
    amd_configs = amd_config_wofolding + amd_config_just_folding
